...
export const BUILDS: Build[] = [
  {
    ...
    prerequisites: ["Python 3.10+", "No API key — the 'decide' step can be a plain rule"],
    instructions: [
      "Write `calculator(expr)` (a Python function).",
      "Write `decide(req)` returning a dict: `{\"tool\": \"calculator\", \"args\": ...}` or `{\"answer\": ...}`.",
